...
export class GlobalInfo extends React.Component {
  ...
  save = () => {
    {
      (this.props.fieldValues.Title = this.state.Title), (this.props.fieldValues.Recipes = this.state.Recipes), (this.props.fieldValues.Description = this.state.Description);
    }
  };
