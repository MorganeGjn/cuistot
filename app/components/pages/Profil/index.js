...
import InputStyle from '../../genericComponents/Input/InputStyle';
import StyledButton from '../Organize/Steps/StyledButton'
import StyleBG from './StyleBG'
import Style from '../Organize/Steps/FirstButton';
...
import Link from '../../genericComponents/Link';
...
export class Profil extends React.Component {
      state = {
        ...
        description: fieldValues.description
          ...
          save = (e) => {
          e.preventDefault()
          {fieldValues.first_name = this.state.first_name,
          fieldValues.last_name = this.state.last_name,
          fieldValues.pictureURL = this.state.pictureURL,
          fieldValues.pictureID = this.state.pictureID,
          fieldValues.gender = this.state.gender,
          fieldValues.city = this.state.city,
          fieldValues.cp = this.state.cp,
          fieldValues.location_point = this.state.location_point,
          fieldValues.description = this.state.description
        }
        }
      ...
      updateDescription = (t) => {
        ...
        render() {
          return (
            ...
            <ReservationLink>
            <Link to='/reservation'> Mes reservations </Link>
            </ReservationLink>
            <StyleBG>
            <FlexWrapper>
              <Column>
              ...
              <Column>
                <Column5>
                    <StyleForm>
                      ...
                      <InputStyle>
                        <input type="text" placeholder="Prénom" ref="first_name"
                               defaultValue={this.state.first_name}
                               onChange={t => this.updateFirstName(t)}
                               size="70"/>
                      </InputStyle>
                      <InputStyle>
                        <input type="text" placeholder="Nom" ref="last_name"
                      ...
                      <InputStyle><input placeholder="Sexe" id="Gender" name="Gender" type="text" list="gender"
                      ...
                      onChange={r => this.updateGender(t)}/>
                        ...
                        <InputStyle>
                          <input type="number" placeholder="Code Postal" ref="cp"
                                 defaultValue={this.state.cp}
                                onChange={r => this.updateCp(t)}
                                size="70"/>
                        </InputStyle>
                        <InputStyle>
                          <input type="text" placeholder="Adresse" ref="location_point"
                                 defaultValue={this.state.location_point}
                                onChange={r => this.updateLocationPoint(t)}
                                size="70"/>
                        </InputStyle>
                      <InputStyle>
                        <textarea rows = '10' cols = '52' placeholder="Description" ref="Description"
