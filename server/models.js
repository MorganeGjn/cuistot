...
// UserAccount Model
const UserAccountModel = db.define(
  'user_account',
  {
    user_id: {
      type: Sequelize.UUID,
...
// Reservation Model
const ReservationModel = db.define(
  'reservation',
  {
    gourmet_id: {
      type: Sequelize.UUID,
...
// UserLogin Model
const UserLoginModel = db.define(
  'user_login',
  {
    name: {
      type: Sequelize.STRING,
